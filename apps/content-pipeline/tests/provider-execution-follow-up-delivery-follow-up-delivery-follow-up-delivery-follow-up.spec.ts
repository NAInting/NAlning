...
describe("provider execution follow-up delivery follow-up post-delivery routing", () => {
  ...
  function buildLatestExecutorChain(): {
    followUpPlan: UnitReviewProviderExecutionFollowUpPlan;
    followUpReceipt: UnitReviewProviderExecutionFollowUpReceipt;
    followUpReconciliation: UnitReviewProviderExecutionFollowUpReconciliation;
    deliveryFollowUp: UnitReviewProviderExecutionFollowUpDeliveryFollowUp;
    ...
    executorReceipt: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpReceipt;
    executorReconciliation: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpReconciliation;
    downstreamRouting: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUp;
    downstreamExecutorPlan: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpPlan;
    downstreamExecutorReceipt: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt;
    downstreamExecutorReconciliation: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliation;
  } {
    ...
    const downstreamExecutorPlan =
      buildUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpPlan(
        downstreamRouting
      );
    const downstreamExecutorReceipt =
      buildUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt(
        downstreamExecutorPlan,
        {
          executed_at: "2026-04-24T01:26:00.000Z",
        }
      );
    const downstreamExecutorReconciliation =
      buildUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliation(
        downstreamExecutorPlan,
        downstreamExecutorReceipt
      );
    ...
    return {
      ...
      downstreamExecutorPlan,
      downstreamExecutorReceipt,
      downstreamExecutorReconciliation,
    };
  }

  function buildLatestArtifactChain(): {
    followUpPlan: UnitReviewProviderExecutionFollowUpPlan;
    followUpReceipt: UnitReviewProviderExecutionFollowUpReceipt;
    followUpReconciliation: UnitReviewProviderExecutionFollowUpReconciliation;
    deliveryFollowUp: UnitReviewProviderExecutionFollowUpDeliveryFollowUp;
    ...
    const executorReceipt =
      buildUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpReceipt(
        executorPlan,
        {
          executed_at: "2026-04-24T01:24:00.000Z",
        }
      );
    const executorReconciliation =
      buildUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpReconciliation(
  ...
  it("keeps trusted artifact handoff branches closed after the downstream executor trio", () => {
    const chain = buildLatestArtifactChain();

    const downstreamRouting =
      buildUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUp(
        chain.downstreamExecutorPlan,
        chain.downstreamExecutorReconciliation
      );

    expect(downstreamRouting).toMatchObject({
      follow_up_state: "result_artifact_handoff_ready",
      follow_up_action: "defer_to_result_artifact_contract",
      follow_up_delivery_follow_up_delivery_follow_up_delivery_follow_up_chain_closed: true,
      result_artifact_handoff: {
        expected_schema_version: "content-pipeline-review-artifact/v0.1",
      },
      active_follow_up_item: {
  ...
  it("routes delivered manual triage branches to manual_follow_up_item_delivered after the downstream executor trio", () => {
    const chain = buildLatestExecutorChain();
    const sourceValidation =
      validateUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpSource(
        baseRequest,
        approvedDecision,
        ...
        chain.executorReconciliation,
        chain.downstreamRouting,
        chain.downstreamExecutorPlan,
        chain.downstreamExecutorReceipt,
        chain.downstreamExecutorReconciliation
      );
    expect(sourceValidation.ok).toBe(true);
  ...
  it("opens receipt triage when the downstream executor receipt no longer validates", () => {
    const chain = buildLatestExecutorChain();
    const invalidExecutorReceipt: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt =
      {
        ...chain.downstreamExecutorReceipt,
        final_follow_up_item_key: "forged-follow-up-item",
      };
  ...
  it("rejects unknown latest executor receipt operation statuses and clears untrusted final target", () => {
    const chain = buildLatestExecutorChain();
    const latestRouting =
      buildUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUp(
        chain.downstreamExecutorPlan,
    ...
    const itemKey =
      "content-pipeline:manual_triage_queue:math_g8_linear_function_intro:latest-receipt-status-regression";
    const manualPlan: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpPlan =
      {
        ...basePlan,
        follow_up_state: "receipt_triage_required",
        follow_up_action: "open_manual_receipt_triage_item",
        delivery_action: "create_follow_up_inbox_item",
        final_follow_up_item_key: itemKey,
        final_follow_up_queue: "manual_triage_queue",
        upsert: {
          operation_key:
            `content-pipeline:provider-execution-follow-up-delivery-follow-up-delivery-follow-up-delivery-follow-up-delivery-follow-up:upsert:${itemKey}`,
          item_key: itemKey,
          human_queue: "manual_triage_queue",
          title: "[Regression] Latest receipt status",
          summary: "Regression fixture for malformed receipt operation status.",
          primary_human_action: "perform_manual_triage",
          automation_step: "open_inbox_item",
          labels: ["content_pipeline_review", "regression"],
        },
        automation_step: "open_inbox_item",
        decision_boundary: {
          requires_provider_execution: false,
    ...
    const receipt =
      buildUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt(
        manualPlan,
        {
          executed_at: "2026-04-24T01:40:00.000Z",
        }
      );
    const malformedReceipt: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt =
      {
        ...receipt,
      ...
      } as unknown as UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt;
  ...
  it("fails closed when downstream provider post-delivery routing builders receive malformed source payloads", () => {
    const chain = buildLatestExecutorChain();
    const malformedExecutorPlan: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpPlan =
      {
        ...chain.downstreamExecutorPlan,
        schema_version:
          "content-pipeline-review-provider-execution-follow-up-delivery-follow-up-delivery-follow-up-delivery-follow-up-plan/invalid",
      } as unknown as UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpPlan;
