...
import {
  ...
  validateUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpPlanContract,
  validateUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpPlanSource,
} from "./provider-execution-follow-up-delivery-follow-up-delivery-follow-up-delivery-follow-up-plan";
import type {
  ProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceiptValidationIssue,
...
export type UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliationStatus =
  | "closed"
  | "action_required";

export type UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpRecommendedFollowUp =
  | "none"
  | "manual_repair_provider_execution_follow_up_delivery_follow_up_delivery_follow_up_delivery_follow_up"
  | "manual_receipt_triage";

export interface UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliation {
  schema_version: "content-pipeline-review-provider-execution-follow-up-delivery-follow-up-delivery-follow-up-delivery-follow-up-reconciliation/v0.1";
  ...
  source_follow_up_receipt_schema_version: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt["schema_version"];
  request_key: string;
  chain_key: string;
  attempt_key: string;
  unit_id: string;
  follow_up_state: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpPlan["follow_up_state"];
  follow_up_action: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpPlan["follow_up_action"];
  receipt_validation_ok: boolean;
  receipt_validation_issue_codes: ProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceiptValidationIssue["code"][];
  reconciliation_status: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliationStatus;
  recommended_follow_up: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpRecommendedFollowUp;
  delivery_status: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt["overall_status"] | null;
  result_artifact_handoff: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpPlan["preserved_result_artifact_handoff"];
  preserved_active_follow_up_item: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpPlan["preserved_active_follow_up_item"];
  final_follow_up_item_key: string | null;
  final_follow_up_queue: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt["final_follow_up_queue"];
  unresolved_operations: Array<{
    operation_key: string;
    operation_type: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt["operations"][number]["operation_type"];
    target_item_key: string;
    status: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt["operations"][number]["status"];
  }>;
}

export interface ProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliationSourceValidationIssue {
  code:
    | "source_follow_up_delivery_follow_up_delivery_follow_up_delivery_follow_up_plan_contract_mismatch"
    | "source_follow_up_delivery_follow_up_delivery_follow_up_delivery_follow_up_receipt_contract_mismatch";
  message: string;
}

export interface ProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliationSourceValidationResult {
  ok: boolean;
  issues: ProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliationSourceValidationIssue[];
}

export interface ProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliationValidationIssue {
  code:
...
export interface ProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliationValidationResult {
  ok: boolean;
  issues: ProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliationValidationIssue[];
}

export function validateUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliationSource(
...
): ProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliationSourceValidationResult {
  const issues: ProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliationSourceValidationIssue[] =
    [];
  ...
  if (!planSourceValidation.ok || !planValidation.ok) {
    ...
    issues.push({
      ...
      message:
        `Provider execution follow-up delivery follow-up delivery follow-up reconciliation source plan chain failed validation: ${issueCodes.join(", ")}.`,
    });
  }
  ...
  if (!receiptSourceValidation.ok || !receiptValidation.ok) {
    ...
    issues.push({
      code: "source_follow_up_delivery_follow_up_delivery_follow_up_delivery_follow_up_receipt_contract_mismatch",
      message:
        `Provider execution follow-up delivery follow-up delivery follow-up reconciliation source receipt chain failed validation: ${issueCodes.join(", ")}.`,
    });
  }
...
export function buildUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliation(
  plan: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpPlan,
  receipt: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt
  ...
  if (!planContractValidation.ok) {
    throw new Error(
      `Provider execution follow-up delivery follow-up delivery follow-up reconciliation source plan is invalid: ${planContractValidation.issues.map((issue) => issue.code).join(", ")}.`
    );
  }
  const receiptValidation =
    validateUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt(
...
export function validateUnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliation(
  plan: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpPlan,
  receipt: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReceipt,
  reconciliation: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliation
): ProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliationValidationResult {
  const issues: ProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliationValidationIssue[] =
    [];
  const expected =
  ...
  if (
    ...
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation schema_version must be content-pipeline-review-provider-execution-follow-up-delivery-follow-up-delivery-follow-up-delivery-follow-up-reconciliation/v0.1.",
    });
  }
  ...
  if (
    ...
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation source_follow_up_plan_schema_version must match the source plan schema_version.",
    });
  }
  ...
  if (
    ...
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation source_follow_up_receipt_schema_version must match the source receipt schema_version.",
    });
  }
  ...
  if (reconciliation.request_key !== expected.request_key) {
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation request_key must match the source plan/receipt chain.",
    });
  }
  ...
  if (reconciliation.chain_key !== expected.chain_key) {
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation chain_key must match the source plan/receipt chain.",
    });
  }
  ...
  if (reconciliation.attempt_key !== expected.attempt_key) {
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation attempt_key must match the source plan/receipt chain.",
    });
  }
  ...
  if (reconciliation.unit_id !== expected.unit_id) {
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation unit_id must match the source plan/receipt chain.",
    });
  }
  ...
  if (reconciliation.follow_up_state !== expected.follow_up_state) {
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation follow_up_state must match the source follow-up plan state.",
    });
  }
  ...
  if (reconciliation.follow_up_action !== expected.follow_up_action) {
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation follow_up_action must match the source follow-up plan action.",
    });
  }
  ...
  if (reconciliation.receipt_validation_ok !== expected.receipt_validation_ok) {
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation receipt_validation_ok must match the actual plan-vs-receipt validation result.",
    });
  }
  ...
  if (
    ...
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation receipt_validation_issue_codes must match the actual follow-up receipt validation issue codes.",
    });
  }
  ...
  if (reconciliation.reconciliation_status !== expected.reconciliation_status) {
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation status must match the derived closure state for the source follow-up receipt.",
    });
  }
  ...
  if (reconciliation.recommended_follow_up !== expected.recommended_follow_up) {
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation recommended_follow_up must match the derived next action for the source follow-up receipt.",
    });
  }
  ...
  if (reconciliation.delivery_status !== expected.delivery_status) {
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation delivery_status must match the trusted source follow-up receipt delivery status.",
    });
  }
  ...
  if (
    ...
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation result_artifact_handoff must match the preserved source artifact handoff contract.",
    });
  }
  ...
  if (
    ...
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation preserved_active_follow_up_item must match the source plan preserved active item.",
    });
  }
  ...
  if (
    ...
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation final follow-up item state must match the trusted source follow-up receipt final state.",
    });
  }
  ...
  if (
    ...
    issues.push({
      ...
      message:
        "Provider execution follow-up delivery follow-up delivery follow-up reconciliation unresolved_operations must match the failed operations in the source follow-up receipt.",
    });
  }
...
function resultArtifactHandoffsMatch(
  actual: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliation["result_artifact_handoff"],
  expected: UnitReviewProviderExecutionFollowUpDeliveryFollowUpDeliveryFollowUpDeliveryFollowUpReconciliation["result_artifact_handoff"]
): boolean {
