...
export interface  {
  ...
  delivery_action: ["delivery_action"];
  executed_at: string;
  overall_status: UnitReviewInboxDeliveryOverallStatus;
  preserved_result_artifact_handoff: ["preserved_result_artifact_handoff"];
  ...
  final_follow_up_queue: ["final_follow_up_queue"];
  operations: Array<{
...
export interface  {
  executed_at: string;
  upsert_status?: UnitReviewInboxDeliveryOperationStatus;
}

export interface  {
  code:
...
export interface  {
  ok: boolean;
  issues: [];
}

export interface  {
  code:
...
export interface  {
  ok: boolean;
  issues: [];
}

export function (
  ...args: [
    ...LatestPlanSourceArgs,
    
  ]
):  {
  const issues: [] =
    [];
  const sourceArgs = args.slice(0, -1) as unknown as LatestPlanSourceArgs;
  const followUp = sourceArgs.at(-1) as ;
  const plan = args.at(-1) as ;
...
export function (
  ...
  options: 
...
export function (
  plan: ,
...
):  {
  const issues: [] =
    [];
...
function pushReceiptMismatchIssues(
  ...
  const scalarChecks: Array<{
    code: ["code"];
    actual: unknown;
    expected: unknown;
    message: string;
  }> = [
